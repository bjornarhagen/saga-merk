(() => {
  ...
  root.innerHTML = `<style>
    ...
    .bar{position:absolute;right:12px;bottom:12px;width:660px;max-width:calc(100vw - 24px);max-height:calc(100vh - 24px);overflow:auto;display:block;padding:16px;background:#111;color:#e8e6e1;border:1px solid #3b3832;border-top:2px solid #e89a3c;border-radius:0;box-shadow:0 16px 48px #0006;pointer-events:auto;font:12px/1.4 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;-webkit-font-smoothing:antialiased;color-scheme:dark}
